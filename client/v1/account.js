...
Account.prototype.parseParams = function (json) {
    ...
    if(_.isString(json.social_context))
        hash.social_context= json.social_context;
    if(_.isString(json.profile_context))
        hash.social_context= json.profile_context;
    if(_.isObject(json.friendship_status))
        hash.friendship_status= json.friendship_status;
    if(hash.isBusiness) {
        if(json.public_email) {
            hash.email= json.public_email;
        }

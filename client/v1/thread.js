...
Thread.prototype.parseParams = function (params) {
    ...
    //console.log("--------PARAMS OMG------");
    //console.log(params);
    
    var hash = {};
    var that = this;
    hash.nextMaxId = params.oldest_cursor;
    hash.moreAvailableMin = params.has_newer;
    ...
    hash.nextMinId = params.newest_cursor;
    hash.muted = !!params.muted;
    hash.moreAvailableMax = !!params.has_older;
